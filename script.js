...
function drawText() {
  ...
  if (frameNumber > 3000 && frameNumber < 99999) {
    ...
    if (window.innerWidth < 600) {
      drawTextWithLineBreaks(
        [
          "I love you so much meri jaan  , more than",
          "all the time and space in the universe can contain. and always do till you are there to hold my hand, till last breath.",
        ],
        canvas.width / 2,
        canvas.height / 2,
        fontSize,
      ...
      context.fillText(
        ...
        " and always do till you are there to hold my hand, till last my breath.",
        canvas.width / 2,
        canvas.height / 2
      );
    }
  ...
  if (frameNumber >= 3600 && frameNumber < 99999) {
    ...
    context.fillText(
      "Will You Be Mine for this life? ", "I love You My Jaan",
      canvas.width / 2,
      canvas.height / 2 + 120
    );
